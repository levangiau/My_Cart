      ...
      <header>
        ...
        >
          ...
          <li>
            <ul className="social">
              <li>
                <a href="#a" className="icons-sm fb-ic">
                  <i className="fa fa-facebook"> </i>
                </a>
              </li>
              <li>
                <a href="#a" className="icons-sm pin-ic">
                  <i className="fa fa-pinterest"> </i>
                </a>
              </li>
              <li>
                <a href="#a" className="icons-sm gplus-ic">
                  <i className="fa fa-google-plus"> </i>
                </a>
              </li>
              <li>
                <a href="#a" className="icons-sm tw-ic">
        ...
        <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
          ...
          <ul className="nav navbar-nav nav-flex-icons ml-auto">
            <li className="nav-item dropdown">
              ...
              >
                <a href="#a" className="dropdown-item waves-effect waves-light">
                  Đăng Ký
                </a>
                <a href="#a" className="dropdown-item waves-effect waves-light">
                  Đăng Nhập
                ...
                <a
                  href="#a"
                  className="dropdown-item waves-effect waves-light logout"
                >
                  Đăng Xuất
                </a>
              </div>
